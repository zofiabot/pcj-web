...
class ConfigurationController extends BaseController
{
	...
	public function testftp($cachable = false, $urlparams = [])
	{
		...
		$model->setState('usessl', $this->input->get('usessl', '', 'cmd') == 'true');
		$model->setState('passive', $this->input->get('passive', '', 'cmd') == 'true');
		$model->setState('passive_mode_workaround', $this->input->get('passive_mode_workaround', '', 'cmd') == 'true');
