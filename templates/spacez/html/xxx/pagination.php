...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<i class="bi bi-chevron-double-left" aria-hidden="true"></i>';
	...
	{
		$display = '<i class="bi bi-chevron-left" aria-hidden="true"></i>';
		$aria		= JText::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
	}
	...
	{
		$display = '<i class="bi bi-chevron-right" aria-hidden="true"></i>';
		$aria		= JText::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
	}
	...
	{
		$display = '<i class="bi bi-chevron-double-right" aria-hidden="true"></i>';
		$aria		= JText::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
	}
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text === JText::_('JLIB_HTML_START'))
	{
		return '<li class="disabled"><a><i class="bi bi-chevron-double-left"></i></a></li>';
	}

	// Check for "Prev" item
	if ($item->text === JText::_('JPREV'))
	{
		return '<li class="disabled"><a><i class="bi bi-chevron-left"></i></a></li>';
	}

	// Check for "Next" item
	if ($item->text === JText::_('JNEXT'))
	{
		return '<li class="disabled"><a><i class="bi bi-chevron-right"></i>></a></li>';
	}

	// Check for "End" item
	if ($item->text === JText::_('JLIB_HTML_END'))
	{
		return '<li class="disabled"><a><i class="bi bi-chevron-diuble-right"></i></a></li>';
	}
