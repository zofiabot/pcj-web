...
($alt == '' && (isset($images->image_intro_caption) && $images->image_intro_caption !== '')) ? 'alt="' . htmlspecialchars($images->image_intro_caption, ENT_COMPAT, 'UTF-8') . '"' : '';
...
?>
	<?php if ($params->get('link_intro_image') && ($params->get('access-view') || $params->get('show_noauth', '0') == '1')) : ?>
		<a href="<?php echo Route::_(RouteHelper::getArticleRoute($displayData->slug, $displayData->catid, $displayData->language)); ?>"
			...
			<img class="card-img-top" src="<?php echo htmlspecialchars($img->url, ENT_COMPAT, 'UTF-8'); ?>"
					 <?php echo $alt; ?>
